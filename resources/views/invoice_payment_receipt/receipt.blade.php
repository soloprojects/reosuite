                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="search_payment_receipt" class="form-control"
                                       onkeyup="searchItem('search_payment_receipt','reload_data','<?php echo url('search_invoice_payment_receipt') ?>','{{url('invoice_payment_receipt')}}','<?php echo csrf_token(); ?>')"
                                       name="search_payment_receipt" placeholder="Search Receipt" >
                            </div>
                        </div>
                    </div>
                </div>               
...
<script>
    ...
    function getData(page){
        ...
        if(searchVal == ''){
            ...
            pageData = '<?php echo url('search_invoice_payment_receipt') ?>?page=' + page+'&searchVar='+searchVal;
        }
