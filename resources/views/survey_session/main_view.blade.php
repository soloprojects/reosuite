        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Survey Session</h4>
                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control" name="survey" >
                                                ...
                                                @foreach($survey as $ap)
                                                    <option value="{{$ap->id}}">{{$ap->survey_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_survey_session'); ?>','reload_data',
                            '<?php echo url('survey_session'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_survey_session'); ?>','reload_data',
                            '<?php echo url('survey_session'); ?>','<?php echo csrf_token(); ?>')"
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('survey_session'); ?>',
                                    '<?php echo url('delete_survey_session'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
