        ...
        <div class="row clearfix">
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" class="form-control" autocomplete="off" id="select_vendor{{$attachToId}}" onkeyup="searchOptionList('select_vendor{{$attachToId}}','myUL{{$attachToId}}','{{url('default_select')}}','search_vendor','vendor{{$attachToId}}');" name="select_vendor" placeholder="Select Vendor">

                        <input type="hidden" class="user_class" name="contact" id="vendor{{$attachToId}}" />
                    </div>
                </div>
                <ul id="myUL{{$attachToId}}" class="myUL"></ul>
            </div>

            @if($searchFormId == 'searchOverdueBillForm')
                ...
                <div class="form-group">
                    <div class="form-line">
                        <select  class="form-control show-tick" name="transaction_type" data-selected-text-format="count">
                            ...
                            @foreach(Finance::vendorTransactions as $ap)
