                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control show-tick" multiple name="financial_year[]" id="fin_year" data-selected-text-format="count">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4" id="" style="">
                                    <div class="form-group">
                                        <button class="btn btn-info" type="button" onclick="searchReportRequest('searchMainForm','<?php echo url('balance_sheet_report'); ?>','reload_data',
                                                '<?php echo url('balance_sheet'); ?>','<?php echo csrf_token(); ?>','from_date','to_date','fin_year')">Run Report</button>
                                    </div>
                                </div>
                            </div>
