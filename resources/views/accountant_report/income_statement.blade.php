                    ...
                    <form name="import_excel" id="searchMainForm" onsubmit="false;" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4" id="" style="">
                                    <div class="form-group">
                                        <button class="btn btn-info" type="button" onclick="searchReportRequest('searchMainForm','<?php echo url('income_statement_report'); ?>','reload_data',
                                                '<?php echo url('income_statement'); ?>','<?php echo csrf_token(); ?>','from_date','to_date','fin_year')">Run Report</button>
                                    </div>
                                </div>
                            </div>
