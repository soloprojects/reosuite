                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="hidden" name="document_id" value="{{$mainData->id}}" />
                                    </form>
                                    <div class="row">
                                        <div class="col-sm-12">
                                                <button type="button" class="form-control pull-right btn-info"
                                                        onclick="submitComment('commentModal','commentMainForm','<?php echo url('comment_document'); ?>','display_comment',
                                                                '<?php echo url('document/'.$mainData->id); ?>','<?php echo csrf_token(); ?>')"
...
<script>
    ...
    <script>
        ...
        fetchCommentInterval('{{$mainData->id}}','comment_class','refresh_comments','{{url('fetch_fresh_document_comments')}}','{{csrf_token()}}')
