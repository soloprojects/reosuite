...
<table class="table table-responsive">
    ...
    <tr>
        <td>File{{$num}}</td>
        <td><a target="_blank" href="<?php echo URL::to('download_inventory_contract_attachment?file='); ?>{{$at}}">
        ...
        <td>
            ...
            <button type="button"  onclick="submitMediaForm('attachModal','removeAttachForm','<?php echo url('remove_inventory_contract_attachment'); ?>','reload_data',
