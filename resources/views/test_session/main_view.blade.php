        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Test Session</h4>
                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control" name="test" >
                                                ...
                                                @foreach($test as $ap)
                                                    <option value="{{$ap->id}}">{{$ap->test_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button onclick="submitDefault('createModal','createMainForm','<?php echo url('create_test_session'); ?>','reload_data',
                            '<?php echo url('test_session'); ?>','<?php echo csrf_token(); ?>')" type="button" class="btn btn-link waves-effect">
                        SAVE
                    </button>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"  onclick="submitDefault('editModal','editMainForm','<?php echo url('edit_test_session'); ?>','reload_data',
                            '<?php echo url('test_session'); ?>','<?php echo csrf_token(); ?>')"
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        ...
                        <li>
                            <button type="button" onclick="deleteItems('kid_checkbox','reload_data','<?php echo url('test_session'); ?>',
                                    '<?php echo url('delete_test_session'); ?>','<?php echo csrf_token(); ?>');" class="btn btn-danger">
                    ...
                    <table class="table table-bordered table-hover table-striped" id="main_table">
                        ...
                        @foreach($mainData as $data)
                            <tr>
                                ...
                                <td>
                                    <a style="cursor: pointer;" onclick="editForm('{{$data->id}}','edit_content','<?php echo url('edit_test_session_form') ?>','<?php echo csrf_token(); ?>')"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                </td>
