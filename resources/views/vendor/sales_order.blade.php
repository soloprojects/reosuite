...
@section('content')
    ...
    <table class="table table-responsive">
        ...
        <tr>
            ...
            <td>Sales No.:{{$data['sales']->sales_number}}</td>
    ...
    <table class="table table-responsive">
        ...
        <tr>
            ...
            <td>{{Utility::numberFormat($data['sales']->tax_trans)}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{Utility::numberFormat($data['sales']->discount_trans)}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{Utility::numberFormat($data['sales']->trans_total)}}</td>
        </tr>
        </tbody>
    </table><hr/>
