                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control show-tick" name="budget1" data-selected-text-format="count">
                                ...
                                <div class="col-sm-4" id="">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select  class="form-control show-tick"  id="" name="budget2" data-selected-text-format="count">
                                                <option value="" selected>Select Budget</option>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-8" id="" style="">
                                    <div class="form-group">
                                        <button class="btn btn-info col-sm-8" type="button" onclick="searchReportBudget('searchMainForm','<?php echo url('search_budget_budget_compare'); ?>','reload_data',
                                                '<?php echo url('budget_budget_compare'); ?>','<?php echo csrf_token(); ?>')">Search</button>
                                    </div>
                                </div>
