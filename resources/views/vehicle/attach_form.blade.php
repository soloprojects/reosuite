<p>
    {{$edit->make->make_name}} {{$edit->model->model_name}} ({{$edit->license_plate}})
</p>
...
<table class="table table-responsive">
    ...
    <tr>
        <td>File{{$num}}</td>
        <td><a target="_blank" href="<?php echo URL::to('download_vehicle_attachment?file='); ?>{{$at}}">
        ...
        <td>
            ...
            <button type="button"  onclick="submitMediaForm('attachModal','removeAttachForm','<?php echo url('remove_vehicle_attachment'); ?>','reload_data',
