...
class CrmActivity extends Model
{
    ...
    public function type(){
        return $this->belongsTo('App\model\CrmActivityType','activity_type','id')->withDefault();

    }

    public function opportunity(){
        return $this->belongsTo('App\model\CrmOpportunity','opportunity_id','id')->withDefault();
